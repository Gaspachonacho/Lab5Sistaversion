...
public class WordQuiz {
	...
	public void menu() throws IOException {
		...
		InputStream ordFil = new FileInputStream ("/home/gasgr424/eclipse-workspace/TDDC77Labs/src/lab5/glosor.txt");
		...
		while (a != 4) {
			...
			switch(a){
				case 1:
					...
					OutputStream spara = new FileOutputStream ("/home/gasgr424/eclipse-workspace/TDDC77Labs/src/lab5/glosor.txt", true);
	...
	public static void main(String[] args) throws IOException {
		...
		WordQuiz wordquiz = new WordQuiz(sweng);
		wordquiz.menu();  
	}
}